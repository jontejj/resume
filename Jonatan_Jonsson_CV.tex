...
\rhead {{\huge \bf{Jonatan Jönsson}} \hfill Västra Prinsgatan 12A\\37135 Karlskrona, Sweden \\(willing to relocate)\\
...
{\bf Software Engineer} Consultant \hfill Nov '10 - Current \\
...
\item Spielo/Gtech/BossMedia in Växjö
	\begin{itemize}
	\itemsep -1pt
	\item Gaming Management System (\href{http://www.spielog2.com/products/spielo-g2-gaming-management-system-(gms).aspx}{GMS)})\hfill Jan '13 - Current
...
\item \href{http://www.ericsson.com/ourportfolio/telecom-operators/ericsson-charging-system?nav=marketcategory007%7Csubarea014}{Ericsson's Charging System} (the Service Data Point part)
	...
	\begin{itemize}
	\itemsep -1pt
 	\item Performance degradation analyzer \hfill Nov '12 - Dec '12
    		 \\After a quick look in JVisualVM I came up with a solution 
		\\that decreased the CPU usage with 3\% per call.
 	\item Design Lead \hfill Aug '11 - Apr '12
     		\\Suggested several development improvements that were accepted
...
{\bf Internship} as Software Architect \hfill Jan '09 - May '09 \\
{\sl at Ericsson AB in Karlskrona}
\begin{itemize}
\itemsep -1pt
\item Developed a testcase generator (in Java) for their charging system
\end{itemize}
...
{\bf Solid skills with} Java, C\#, C++, Objective-C, Python, PHP, SQL, HTML, CSS, Javascript\\
{\bf Have used} C, .NET, APS.NET, LISP, Riak, Sybase, TimesTen, CG, Assembler (MIPS), MATLAB, KSH, TCSH, TTCN3 \\
{\bf Frameworks} Guava, Spring, Hibernate, Django, SDL, iOS SDK, XNA, Boost, Protobuf \\
{\bf Operating Systems} Mac OS X, Windows, Ubuntu, Solaris\\
{\bf Tools} Eclipse, Maven, Ant, XCode, Visual Studio, JIRA\\
{\bf Processes} TDD, Pair Programming, Code reviews, Kanban, Scrum, XP\\
{\bf VCS} Git, Subversion (SVN), Mercurial, ClearCase\\
...
%\item [Erik Backlund] {\sl Hanashi project}, Sony Ericsson \\
%+46 108019606, erik.backlund@sonyericsson.com

%\item [Mikael Roos] {\sl Director of studies}, Blekinge Tekniska Högskola \\
%+46 7034-021168, mikael.roos@bth.se

%\item [Thomas Letterkrantz] {\sl DM TeC}, Softhouse \\
%+46 768 832469, thomas.letterkrantz@softhouse.se

%\item [Ulf Seijsing] {\sl Site Manager}, Softhouse \\
%+46 768 832460, ulf.seijsing@softhouse.se
